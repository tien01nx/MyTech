...
public class SetTeacher_Activity extends PortraitActivity {
    ...
    private void setUpViewPager() {
        ViewPaget_TeacherAdapter viewPagetAdapter = new ViewPaget_TeacherAdapter(getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
